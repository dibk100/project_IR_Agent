...
def train_model(dataset):
    ...
    model = LogisticRegression(penalty='l2')  # Ensure penalty is 'l2' for lbfgs solver
...
def prepare_model_for_deployment(model):
    ...
    os.makedirs('./agent_workspace/trained_models', exist_ok=True)  # Ensure the directory exists
